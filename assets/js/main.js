...
angular.module('synesim')
	.directive('synesimColorMapEditor', ["synesim", function(synesim) {
...
angular.module('synesim')
	.service('colorMapRemote', ["$q", "$http", function($q, $http) {
...
angular.module('synesim')
	.config(["$provide", "$logProvider", "$urlRouterProvider", "$stateProvider", function($provide, $logProvider, $urlRouterProvider, $stateProvider) {

		//$logProvider.debugEnabled(false);

		$provide.decorator('synesim', ["$delegate", function($delegate) {
...
angular.module('synesim')
	.controller('synesimController', ["$log", "$scope", "synesim", function($log, $scope, synesim) {
...
angular.module('synesim')
	.service('synesim', ["$q", "colorMapRemote", "colorMapLocal", function($q, colorMapRemote, colorMapLocal) {
...
angular.module('synesim')
	.directive('synesimTextEditor', ["synesim", function(synesim) {
